...
#define PRJOIN	    4       /**< process is ready to join another thread */ /* We added this in (Salvador and Sierra) */
#define PRWAIT      5       /**< process has a negative semaphore count, Thus, it must wait in the semaphore queue */
...
typedef struct pentry
{
    ...
    //--my input
    unsigned int tickets;	/* Number of tickets to be given to a process */
    unsigned long joinq; 	/**< Create a new queue to house "waiting" threads belonging to respective processes */
} pcb;
